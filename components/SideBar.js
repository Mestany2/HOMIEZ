...
const SideBar = ({ profile, client }) => (
  <>
    <div className="side-bar">
      <br />
      {profile ? (<><Image style={{ width: '5rem', height: '100', borderRadius: '100px' }} src={profile?.realtor_image} /><h5>{profile?.realtor_name }</h5><br /><Link passHref href="/"> Dashboard </Link> <br /><Link passHref href="/ListOfHouses" className="links"> Houses For Sale </Link><br /><Link passHref href="/mortgageCalculator"> Mortgage Calculator </Link><br /><br /></>)
