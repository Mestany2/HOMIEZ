...
const SideBar = ({ profile, client }) => (
  <>
    <div className="side-bar">
      <br />
      {profile ? (<><Image style={{ width: '5rem', height: '100', borderRadius: '100px' }} src={profile?.realtor_image} /><h5>{profile?.realtor_name }</h5><br /><Link passHref href="/" className="links"> View Homes </Link><br /><br /><Link passHref href="/"> My Clients </Link><br /></>)
